...
finalreport:
	...
	cat report*.txt | tail -n +2 | mail -s "SEDM DRP Report for $(current_dir)" neill@srl.caltech.edu,rsw@astro.caltech.edu,fremling@caltech.edu,jesper@astro.su.se,lezmy@ipnl.in2p3.fr,tda@lists.astro.caltech.edu
