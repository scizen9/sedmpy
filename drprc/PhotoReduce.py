"""Conduct automatic reduction of SEDM RC data in sedmdrp@pharos
...
Note:
    This is used as a python script as follows::
        ...
        usage: PhotoReduce.py [-h] [--rawdir RAWDIR] [--reduxdir REDUXDIR]
...
_reduxpath = cfg_parser.get('paths', 'photpath')
...
if __name__ == '__main__':
    ...
    go(rawd=args.rawdir, redd=args.reduxdir, wait=args.wait,
       ...
       local=args.local, nodb=args.nodb)
