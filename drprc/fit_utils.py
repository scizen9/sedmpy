...
Updated on Thu Feb 20 2020 by neill
...
def fit_gauss(img):
    ...
    initial_guess = (10000, def_x, def_y, def_fwhm, def_fwhm, 0,
                     np.percentile(img, 40))
    
    print(initial_guess)
    
    popt, pcov = opt.curve_fit(twod_gaussian, (xx, yy), img.flatten(),
                               p0=initial_guess)
